...
class Matchs:
    ...
    def match_day_timetable(self)-> dict:
        ...
        day_per_match_input = int(input("per day match maximum per day 3 matchs so, enter the your wise in monday to friday match:  "))
        
        day_per_match_input2 = int(input("per day match maximum per day 5 matchs so, enter the your wise in saturday and sunday :  "))
